...
export const LogEntry: React.FC<LogEntryProps> = ({
  ...
  return (
    <div
      className={`group relative p-4 cursor-pointer transition-all duration-200 border-l-4 ${getLevelIndicatorColor(log.level)} ${
      ...
      <div className="relative flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mb-3 flex-wrap">
            {/* Level badge */}
            <span className={`${getLogLevelBadge(log.level, theme)} transition-all duration-200 group-hover:scale-105`}>
              {log.level}
            </span>

            {/* Timestamp */}
            <div className={`flex items-center gap-1 text-sm ${themeClasses.text.secondary} font-mono`}>
          ...
          <div className="space-y-2">
            <div className={`font-mono text-sm leading-relaxed break-words ${themeClasses.text.primary} p-3 rounded-lg ${
